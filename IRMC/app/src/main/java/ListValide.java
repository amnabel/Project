...
public class ListValide  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_valide);
...
/*        btnInscription.setOnClickListener(new View.OnClickListener() {
    ...
    public void getUserList(){
        Call<List<Event>> call = serviceEvent.getEventValide(true);
        call.enqueue(new Callback<List<Event>>() {
            @Override
            public void onResponse(Call<List<Event>> call, Response<List<Event>> response) {
                if(response.isSuccessful()){
                    list = response.body();
                    listView.setAdapter(new EventAdapter(ListValide.this, R.layout.list_valide,list));
                }
            }
